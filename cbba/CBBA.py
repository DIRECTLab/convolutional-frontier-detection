"""
This code was taken from https://github.com/keep9oing/consensus-based-bundle-algorithm/
"""
...
class CBBA_agent():
    def __init__(self, position, id=None, vel=None, task_num=None, agent_num=None, L_t=None):
        ...
        self.state = np.reshape(position, (1, 2))  # Agent State (Position)
