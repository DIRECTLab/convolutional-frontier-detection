...
class ConvolutionalFrontierDetector:
    def __init__(self):
        rospy.init_node("frontier_detection")
        
        
        timer_period = 10.0
        r = rospy.Rate(1 / timer_period)

        self.publisher = rospy.Publisher("/frontiers", PoseArray, queue_size=10)
        ...
        self.map_subscription = rospy.Subscriber(
            '/map',
            OccupancyGrid,
    ...
    def publish_frontiers(self):
        ...
        print(f"Published {len(poses)} frontiers")




if __name__ == "__main__":
    cfd = ConvolutionalFrontierDetector()
